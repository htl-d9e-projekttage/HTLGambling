...
<main class="container w-full mx-auto flex justify-center h-screen">
	<Card class="w-full overflow-auto" size="md">
        ...
        <form method="post" action="?/verify" use:enhance onsubmit={(e) => loading = true} class="flex flex-col gap-1">
			<div>
				<Label for="a1">Würden Sie sich als spielsüchtig identifizieren?</Label>
				<Input name="a1" required placeholder="Antwort..." />				
			</div>
			<div>
				<Label for="a2">Wie viele Stunden planen Sie, pro Tag zu spielen? Wie viele Stunden spielen Sie tatsächlich?</Label>
			...
			<div>
				<Label for="a4">Haben Sie schoneimal Dinge verkauft, um spielen zu können oder um Schulden zu begleichen?</Label>
			...
			<div>
				<Label for="a9">Haben Sie schon einmal versucht, mit dem Spielen aufzuhören und ist es Ihnen gelungen?</Label>
				<Input name="a9" required placeholder="Antwort..."/>
			</div>
			<div>
				<Label for="a10">Wie oft spielen Sie pro Woche? Wie viel Geld geben Sie pro Woche fürs Spielen aus?</Label>
